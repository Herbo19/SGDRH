...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Criar Meta</h6>
        ...
        <div class="card-body">
          ...
          @endif
          <form class=""  method="post" action="{{url('cargo')}}">
            @csrf
              <div class="table-responsive">
                  <table class="table table-bordered" id="dataTable" width="10%" cellspacing="0">
                    <tr>
                      <th>Titulo</th>
                      <td>
                        <input type="text" class="form-control" name="tituloCargo" value="">
                      </td>
                    </tr>
                    <tr>
                      <th>Descrição</th>
